...
class LSTM(nn.Module):
    def __init__(self, input_size, hidden_size, output_size=1, seq_length=12, dropout_prob=0.2, num_layers=2):
        super().__init__()
        ...
        self.tanh = nn.Tanh()
        self.linear = nn.Linear(hidden_size, output_size * seq_length, dtype=torch.float64)
